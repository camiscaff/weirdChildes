...
A total of `r length(lang_temp)` different languages or language combinations (for bilingual and multilingual children) were reportedly spoken in the corpora. The monolingual samples spoke `r mono_langs`, and the multilingual samples spoke `r multi_langs`.
...
We then investigated the extent to which samples themselves captured families with diverse backgrounds. 

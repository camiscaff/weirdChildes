...
title: "Supplementary to How WEIRD is what we know about children's linguistic input
  from CHILDES? Appendix 1: Knitted analyses and supplementary analyses with a different 
...
### Causal links between Rich/Educated parents and language outcomes

The ways in which SES relates to children's linguistic input are manifold. Some evidence suggests that SES correlates with maternal speech generally, as differences in quantity of speech, complexity of the lexicon, and sentence length are found not only in their speech to infants but also in speech to a researcher (Hoff-Ginsberg, 1991). Additionally, Hoff (2003) proposes SES may affect children's language input through other causal pathways, including cultural ones like parental beliefs (e.g., regarding the importance of talking to the child and the desirability of talkativeness in the child, which we discuss below under the Industrialized subsection), and practical ones like the amount of time and energy mothers may have to dedicate to one-on-one interactions, which may be related to income issues discussed below in this subsection. Even more complex causal models can be posited, particularly when attempting to integrate multi-cultural data (Hoff et al., 2012).

Some of this complexity relates to the fact that SES is a composite concept. Education, wealth, and occupation, although often confounded in natural samples, are not conceptually identical and can be decorrelated in certain cases. For example, Calzada et al. (2014) documented the divergence in education and wealth found among Spanish-speaking immigrants to the USA: nearly 62% of Mexican-born mothers had less than a high school education, and 84% of those families lived in poverty, whereas only 18% of Dominican-born mothers had not completed high school, and 61% of those families lived in poverty. In general terms, then, some Dominican-born mothers may be highly educated, but may still receive low wages and work in a white collar job as do other Spanish-speaking immigrants. 

Of the different components of SES, parental education is the most commonly used in language acquisition and more broadly developmental research (Hoff et al., 2012; see Dailey and Bergelson (2021) for a meta-analysis). There may be a few reasons why education is so frequently used, including higher stability (it is more stable over the child's early years than income and occupation) and lower sensitivity (in some countries, it is not culturally appropriate to ask for information about income). Moreover, some have made the case that education is empirically more relevant (i.e., explains more of the variance)  in the context of early language acquisition (Hoff, 2003; Bornstein et al., 2003), although this was based on a small number of American samples, and thus it may not generalize to other populations. Regarding the precise causal pathways whereby variation in education relates to variation in children's linguistic input, it is likely that more educated mothers have more exposure to formal school environments, which may socialize individuals to communicate using more literary registers. It may also increase the likelihood that parents read, so that parents who have had longer schooling experiences are more likely to draw on those experiences when they communicate with their children, leading to more diverse lexicons and longer phrases. To note, both maternal education and measures of language and literacy predicted variation in child-directed speech in a large sample of low-SES American mothers (Rowe et al., 2005).

Although much attention has been focused on education, as opposed to income, we think it is worthwhile to consider potential ways in which income may relate to children's language input, for both conceptual and empirical reasons. Conceptually, parents’ income may affect children’s verbal environments through a different set of routes than parental education. To begin with, low income families might live in denser homes, a factor which has been found to be related to children’s language experience - caregivers in more crowded homes being less responsive to their children than parents in less crowded homes (Evans et al., 1999, 2010). Parents with low levels of income may also experience daily hardships such as food and medical insecurity. A recent paper makes the case for considering the impact of (financial) scarcity on caregivers’ quantity of speech to their children (Ellwood-Lowe, et al., 2022), and scarcity could also lead to indirect effects. Indeed, lower-income parents live in harsher situations and are more likely than higher-income parents to be depressed (Berger, Paxson, & Waldfogel, 2009). Controlling for SES, depressed mothers direct less talk to their children (e.g., Porritt, Zinser, Bachorowski, & Kaplan, 2014), use less diverse words (Rowe et al., 2005), and are less likely to adjust their speech to their babies than non-depressed mothers (Reissland, Shepherd, & Herrera, 2003). 
	
Empirical evidence also suggests parents' wealth may matter, above and beyond education. For example, McNally, McCrory, Quigley, and Murray (2019) found that the correlations between maternal education and children's vocabulary outcomes in an Irish sample was statistically mediated by various resources, saliently household income. Additionally, intervention studies and studies of child outcomes associated with changes in national welfare reforms also indicate that increasing income for poor families is related to improvements in children’s outcomes (Duncan & Magnuson, 2012). 


Calzada, E. J., Huang, K. Y., Linares-Torres, H., Singh, S. D., & Brotman, L. (2014). Maternal familismo and early childhood functioning in Mexican and Dominican immigrant families. Journal of Latina/o Psychology, 2(3), 156.

### More information on theories bearing on industrialization

One may wonder why parents behave differently. A framework from evolutionary psychology argues that different modes of societal organization may lead to diverse ideal parental investment strategies. For example, LeVine and collaborators (e.g., Sharma & Levine, 1998; Richman et al., 1998) highlight the complex set of factors leading to differences between families in (post-)industrial and rural settings. Urban, (post-)industrial societies tend to have a great deal of inequality of resources paired with an assumption that it is possible to change one's place in the socioeconomic ladder via education, leading to parents who hope that their children will succeed in school, to have a chance at better-paying jobs, and who may therefore be interested in boosting their children's verbal skills. In LeVine et al. (1994), the authors describe farming parents as employing a "pediatric model" emphasizing contact behaviors with the child, whereas industrialist parents employ a "pedagogical model", prioritizing distal verbal behaviors. 

Parental investment may also vary among non-industrial societies, as argued, for instance, in Draper and Harpending XXX. Those authors believed that the optimal parental investment strategy among foragers involved high levels of parental investment on each individual child, including father involvement, whereas among farmers overall levels of investment should be lower, with much of the care being provided by siblings. These descriptions lead to predictions in terms of both quantity and composition of the input. In particular, LeVine et al. (1994)'s description predicts more child-directed speech in urban than rural settings, a prediction which was born out in a recent systematic review (Cristia, 2022). Although fathers have been observed to, for instance, hold their infants more frequently in foraging than farming societies (e.g., see a summary on paternal investment in Hewlett & MacFarlan Chapter 14), to our knowledge, no study has specifically checked whether fathers' speech is more prevalent in foraging than farming communities. 

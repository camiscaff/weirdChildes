---
title: "Supplementary to How WEIRD is what we know about children's linguistic input from CHILDES? \\ Appendix 1: Knitted analyses and supplementary analyses with a different implementation of Education"
output: 
  pdf_document:
    toc: true
    toc_depth: 2
...
colSums(!is.na(annotations[,c("country","Education.Naomi","SES.Naomi","Parental.profession","Language.or.Languages.spoken.in.recordings",
...
ed <- ggplot(dens_dat, aes(x = completed.LSS, fill = in.childes)) + geom_density(alpha = 0.5) + theme(legend.position = c(0.25, 0.8), axis.title.y=element_blank() , legend.title = element_blank())+labs( x = "Percent completed lower secondary school")+ scale_fill_colorblind()

...
ind_all$western<-0
ind_all$western[ind_all$simple_region %in% c('Western Europe',"Northern America")]<-1
...
```{r}
p <- ggpairs(ind_all[,c('western','log_gdp','SE.SEC.CUAT.UP.ZS','SP.URB.TOTL.ZS','log2_fert')], title="Association across vars: all countries") 
p
...
```{r}
p2 <- ggpairs(ind[,c('western','log_gdp','SE.SEC.CUAT.UP.ZS','SP.URB.TOTL.ZS','log2_fert')], title="Association across vars: childes") 
p2

...
# WDIsearch('Educational attainment')
# Naomi: secondary, some college, university, 
# WDI:  SE.SEC.CUAT.UP.ZS   Educational attainment, at least completed upper secondary, population 25+, total (%) (cumulative)
# WDI:  SE.TER.CUAT.BA.ZS   Educational attainment, at least Bachelor's or equivalent, population 25+, total (%) (cumulative)
dat = WDI(indicator=c('NY.GDP.PCAP.PP.KD','SE.SEC.CUAT.UP.ZS','SE.TER.CUAT.BA.ZS','SP.RUR.TOTL.ZS'), country=c(levels(annotations$country_WB)), start=2012, end=2012)
...
table(!is.na(annotations$Education.mid),!is.na(annotations$SE.TER.CUAT.BA.ZS)) #too little data

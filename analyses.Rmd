...
colSums(!is.na(annotations[,c("country","Education.Naomi","SP.URB.TOTL.ZS","SES.Naomi","Parental.profession","Type.of.community.at.the.time.of.the.recordings","Language.or.Languages.spoken.in.recordings",
                    "Minority", "Household.structure","Proportion.With.Siblings","Average.number.of.siblings")]))
